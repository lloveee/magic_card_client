...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        public RemoteTables(DbConnection conn)
        {
            ...
            AddTable(CardFactionWeight = new(conn));
            AddTable(CardLevelWeight = new(conn));
            AddTable(CardTypeWeight = new(conn));
            AddTable(DataSignature = new(conn));
            AddTable(HeroCard = new(conn));
            AddTable(MatchContext = new(conn));
            AddTable(MatchQueue = new(conn));
            AddTable(PlayerAccount = new(conn));
            AddTable(PlayerBaseHand = new(conn));
            AddTable(PlayerBench = new(conn));
            AddTable(PlayerContext = new(conn));
            AddTable(PlayerTimerSchedule = new(conn));
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            return update.ReducerCall.ReducerName switch
            {
                ...
                "CancelMatch" => BSATNHelpers.Decode<Reducer.CancelMatch>(encodedArgs),
                ...
                "PlayerReady" => BSATNHelpers.Decode<Reducer.PlayerReady>(encodedArgs),
                "PlayerRename" => BSATNHelpers.Decode<Reducer.PlayerRename>(encodedArgs),
                "PlayerTimer" => BSATNHelpers.Decode<Reducer.PlayerTimer>(encodedArgs),
                "ReInsertHeroCard" => BSATNHelpers.Decode<Reducer.ReInsertHeroCard>(encodedArgs),
                "RequestDealCard" => BSATNHelpers.Decode<Reducer.RequestDealCard>(encodedArgs),
                "SwitchTime" => BSATNHelpers.Decode<Reducer.SwitchTime>(encodedArgs),
                "TryEnqueuePlayer" => BSATNHelpers.Decode<Reducer.TryEnqueuePlayer>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            return reducer switch
            {
                ...
                Reducer.CancelMatch args => Reducers.InvokeCancelMatch(eventContext, args),
                ...
                Reducer.PlayerTimer args => Reducers.InvokePlayerTimer(eventContext, args),
                Reducer.ReInsertHeroCard args => Reducers.InvokeReInsertHeroCard(eventContext, args),
                Reducer.RequestDealCard args => Reducers.InvokeRequestDealCard(eventContext, args),
                Reducer.SwitchTime args => Reducers.InvokeSwitchTime(eventContext, args),
                Reducer.TryEnqueuePlayer args => Reducers.InvokeTryEnqueuePlayer(eventContext, args),
